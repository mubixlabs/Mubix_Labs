...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-white/90 backdrop-blur-sm py-20">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mx-auto mt-14 max-w-2xl rounded-3xl border border-zinc-100 bg-white p-8 shadow-sm sm:p-10"
        >
